...
namespace _3dbinpscking
{
    public class sa3dpacking
    {
        ...
        /// <returns></returns>
        public double packing(List<itembox> pbox)
        {
            ...
            itembox = newboxes;
            double Fbest = pack.Setpoint(itembox);//最优填充率
            double fz = Fbest;
        ...
        List<itembox> niegbourhood(List<itembox> itembox)
        {
            ...
            int c = 1;
            //string[] coordinate = new string[] { "x", "y", "z" };
